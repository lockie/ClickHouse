...
/// Regression for incident #1682.
TEST(ThreadGroupSwitcher, FailedConstructionRestoresPreviousState)
{
    auto context = getContext().context;

    std::exception_ptr ex;
    bool detached_case_ok = false;
    bool attached_case_ok = false;
    ...
    std::thread t([&]
    {
        try
        {
            ...
            FailPointInjection::enableFailPoint(FailPoints::thread_group_switcher_attach_failure);
            {
                ...
                detached_case_ok = (getCurrentThreadGroup() == nullptr);
            }
            ...
            FailPointInjection::enableFailPoint(FailPoints::thread_group_switcher_attach_failure);
            {
                ...
                attached_case_ok = (getCurrentThreadGroup() == G0);
            }
